...
export class Skill extends React.Component<ISkillProps, ISkillState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="skill-heading">
          <Translate contentKey="characterCreatorApp.skill.home.title">Skills</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="characterCreatorApp.skill.home.createLabel">Create new Skill</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('title')}>
                    <Translate contentKey="characterCreatorApp.skill.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('descriptionShort')}>
                    <Translate contentKey="characterCreatorApp.skill.descriptionShort">Description Short</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('descriptionLong')}>
              ...
              <tbody>
                {skillList.map((skill, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{skill.title}</td>
                    <td>{skill.descriptionShort}</td>
                    <td>{skill.descriptionLong}</td>
