...
export type ICharacterState = IPaginationBaseState;

export class Character extends React.Component<ICharacterProps, ICharacterState> {
    ...
    return (
      <div>
        <h2 id="character-heading">
          <Translate contentKey="characterCreatorApp.character.home.title">Characters</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="characterCreatorApp.character.home.createLabel">Create new Character</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="characterCreatorApp.character.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="characterCreatorApp.character.user">User</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
